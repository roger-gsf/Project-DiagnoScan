...
public class DiseaseSearch extends javax.swing.JFrame {

    Menu menu;

    public DiseaseSearch(Menu menu) {
        initComponents();
        this.menu = menu;
    }
    ...
    private void initComponents() {
        ...
        lblText.setText("Search for disease name:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiseaseSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiseaseSearch(new Menu()).setVisible(true);
            }
        });
    }
