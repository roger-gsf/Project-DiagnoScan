...
public class SearchSymptom extends javax.swing.JFrame {
    ...
    public SearchSymptom(Menu menu) {
        initComponents();
        this.menu = menu;
    }
    ...
    private void initComponents() {
        ...
        lblSymptom.setText("Search symptom:");
...
// Confirm the deletion
    ...
    private void rbtnSymptomIdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rbtnSymptomIdItemStateChanged
        lblSymptom.setText("Search symptom by id:");
    ...
    private void rbtnSymptomNameItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rbtnSymptomNameItemStateChanged
        lblSymptom.setText("Search symptom by name:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchSymptom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SearchSymptom(new Menu()).setVisible(true);
        });
    }
