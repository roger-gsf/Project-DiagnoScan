...
public class SymptomRegistration extends javax.swing.JFrame {
    
    Menu menu;
    
    public SymptomRegistration(Menu menu) {
        initComponents();
        this.menu = menu;
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SymptomRegistration.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SymptomRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SymptomRegistration(new Menu()).setVisible(true);
            }
        });
    }
